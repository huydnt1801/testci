...
func (sc *SessionCreate) SetDriverID(i int) *SessionCreate {
	sc.mutation.SetDriverID(i)
	return sc
}

// SetNillableDriverID sets the "driver_id" field if the given value is not nil.
func (sc *SessionCreate) SetNillableDriverID(i *int) *SessionCreate {
	if i != nil {
		sc.SetDriverID(*i)
	}
	return sc
...
func (sc *SessionCreate) SetExpireIn(t time.Time) *SessionCreate {
	sc.mutation.SetExpireIn(t)
	return sc
}

// SetRevoked sets the "revoked" field.
func (sc *SessionCreate) SetRevoked(b bool) *SessionCreate {
	sc.mutation.SetRevoked(b)
	return sc
}

// SetNillableRevoked sets the "revoked" field if the given value is not nil.
func (sc *SessionCreate) SetNillableRevoked(b *bool) *SessionCreate {
	if b != nil {
		sc.SetRevoked(*b)
	}
	return sc
...
func (sc *SessionCreate) SetDriver(v *VehicleDriver) *SessionCreate {
	return sc.SetDriverID(v.ID)
}
...
func (sc *SessionCreate) defaults() {
	...
	if _, ok := sc.mutation.Revoked(); !ok {
		v := session.DefaultRevoked
		sc.mutation.SetRevoked(v)
	}
}
...
func (sc *SessionCreate) check() error {
	...
	if _, ok := sc.mutation.ExpireIn(); !ok {
		return &ValidationError{Name: "expire_in", err: errors.New(`ent: missing required field "Session.expire_in"`)}
	}
	if _, ok := sc.mutation.Revoked(); !ok {
...
func (sc *SessionCreate) createSpec() (*Session, *sqlgraph.CreateSpec) {
	...
	if value, ok := sc.mutation.ExpireIn(); ok {
		_spec.SetField(session.FieldExpireIn, field.TypeTime, value)
		_node.ExpireIn = value
	}
	if value, ok := sc.mutation.Revoked(); ok {
	...
	if nodes := sc.mutation.DriverIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
...
// SetDriverID sets the "driver_id" field.
func (u *SessionUpsert) SetDriverID(v int) *SessionUpsert {
	u.Set(session.FieldDriverID, v)
	return u
}

// UpdateDriverID sets the "driver_id" field to the value that was provided on create.
func (u *SessionUpsert) UpdateDriverID() *SessionUpsert {
	u.SetExcluded(session.FieldDriverID)
	return u
}

// ClearDriverID clears the value of the "driver_id" field.
func (u *SessionUpsert) ClearDriverID() *SessionUpsert {
	u.SetNull(session.FieldDriverID)
	return u
}

// SetSessionID sets the "session_id" field.
func (u *SessionUpsert) SetSessionID(v string) *SessionUpsert {
...
// SetExpireIn sets the "expire_in" field.
func (u *SessionUpsert) SetExpireIn(v time.Time) *SessionUpsert {
	u.Set(session.FieldExpireIn, v)
	return u
}

// UpdateExpireIn sets the "expire_in" field to the value that was provided on create.
func (u *SessionUpsert) UpdateExpireIn() *SessionUpsert {
	u.SetExcluded(session.FieldExpireIn)
	return u
}
...
// SetDriverID sets the "driver_id" field.
func (u *SessionUpsertOne) SetDriverID(v int) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.SetDriverID(v)
	})
}
...
// UpdateDriverID sets the "driver_id" field to the value that was provided on create.
func (u *SessionUpsertOne) UpdateDriverID() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateDriverID()
	})
}
...
// ClearDriverID clears the value of the "driver_id" field.
func (u *SessionUpsertOne) ClearDriverID() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.ClearDriverID()
	})
}
...
// SetSessionID sets the "session_id" field.
func (u *SessionUpsertOne) SetSessionID(v string) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.SetSessionID(v)
	})
}
...
// SetExpireIn sets the "expire_in" field.
func (u *SessionUpsertOne) SetExpireIn(v time.Time) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.SetExpireIn(v)
	})
}
...
// UpdateExpireIn sets the "expire_in" field to the value that was provided on create.
func (u *SessionUpsertOne) UpdateExpireIn() *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateExpireIn()
	})
}
...
// SetDriverID sets the "driver_id" field.
func (u *SessionUpsertBulk) SetDriverID(v int) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetDriverID(v)
	})
}
...
// UpdateDriverID sets the "driver_id" field to the value that was provided on create.
func (u *SessionUpsertBulk) UpdateDriverID() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateDriverID()
	})
}
...
// ClearDriverID clears the value of the "driver_id" field.
func (u *SessionUpsertBulk) ClearDriverID() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.ClearDriverID()
	})
}
...
// SetSessionID sets the "session_id" field.
func (u *SessionUpsertBulk) SetSessionID(v string) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetSessionID(v)
	})
}
...
// SetExpireIn sets the "expire_in" field.
func (u *SessionUpsertBulk) SetExpireIn(v time.Time) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetExpireIn(v)
	})
}
...
// UpdateExpireIn sets the "expire_in" field to the value that was provided on create.
func (u *SessionUpsertBulk) UpdateExpireIn() *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.UpdateExpireIn()
	})
}
